...
public class CalculateAmount extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.calculate_amount.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>public.calculate_amount._1</code>.
     */
    ...
    public CalculateAmount() {
        super("calculate_amount", Public.PUBLIC, SQLDataType.DOUBLE);
