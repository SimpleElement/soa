...
public class AmountConsumable extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.amount_consumable.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>public.amount_consumable._1</code>.
     */
     ...
     */
    public AmountConsumable() {
        super("amount_consumable", Public.PUBLIC, SQLDataType.DOUBLE);
